...
@Component("sinaNewsStockPuller")
public class SinaNewsStockPuller implements NewsPuller {
    private static final Logger logger = LogManager.getLogger(SinaNewsStockPuller.class);
    ...
    public void pullNews() {
        ...
        // 要爬取的首页 URL
        String homeUrl = "https://finance.sina.com.cn/stock/";
