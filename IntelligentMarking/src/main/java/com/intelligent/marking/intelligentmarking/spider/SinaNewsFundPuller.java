...
@Component("sinaNewsFundPuller")
public class SinaNewsFundPuller implements NewsPuller {
    private static final Logger logger = LogManager.getLogger(SinaNewsFundPuller.class);
